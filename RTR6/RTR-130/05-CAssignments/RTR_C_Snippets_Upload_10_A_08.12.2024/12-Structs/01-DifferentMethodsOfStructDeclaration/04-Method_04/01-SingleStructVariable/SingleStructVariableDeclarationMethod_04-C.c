...
int main(void)
{
	...
	struct MyData data; //declaring a single struct variable of the type 'struct MyData' lovcally...
	int i_size_aab;
	int f_size_aab;
	int d_size_aab;
	...
	printf("Size of 'i_aab' bytes\n", i_size_aab);
	printf("Size of 'f_aab' bytes\n", f_size_aab);
	printf("Size of 'd_aab' bytes\n", d_size_aab);
