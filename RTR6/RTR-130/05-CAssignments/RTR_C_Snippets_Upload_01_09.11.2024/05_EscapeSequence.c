...
int main(void)
{
	...
	printf("Demonstrating \r Caeeiage Return Using \\r Escape Sequence\n");
	printf("Demonstrating Carriage \r Return Using \\r Escpe S equence\n\n");

	printf("Demonstrating \x41 Using \\xhh Escape Sequence \n\n");
	/*0x41 Is The Hexadecimal Code For Letter 'A'.'xhh Is The Place-holder For 'x' Followed By 2 digits
	(hh), altogether forming a Hexadecimal Number.*/
	printf("Demonstrating \102 Using \\ooo Escape Sequence\n\n");
	/*102 Is The Octal Code For Letter 'B'.'ooo' Is Place-holderr For 3 Digits Forming An Octal Number.*/
	return(0);
