...
void display(void)
{
	...
	glRotatef(angleTraingle, 0.0f, 1.0f, 0.0f);
...
{
	// code
	angleTraingle = angleTraingle + 0.04f;

	if (angleTraingle >= 360.0f)
	{
		(angleTraingle = angleTraingle - 360.0f);
	}

	angleRectangle = angleRectangle - 0.04f;
