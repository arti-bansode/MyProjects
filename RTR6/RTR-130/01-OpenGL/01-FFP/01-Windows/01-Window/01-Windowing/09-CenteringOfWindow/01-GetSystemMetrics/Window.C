...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	//finding x & y co-ordinates for screen mid
	...
	// create window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,szAppName, TEXT("Arti Amol Bansode"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, posX, posY, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
